                ...
                <div class="project-one__top">
                    <div class="section-title text-left">
                        ...
                        <div class="section-title__title-box sec-title-animation animation-style2">
                            <h4 class="section-title__title title-animation">At JAS, we pride ourselves on serving a diverse and extensive client base that spans across various industries. </h4>
                        </div>
                    </div>
                    <!-- <div class="project-one__btn-box">
                        <a href="#" class="project-one__btn thm-btn">all Gallery</a>
                    </div> -->
                </div>
                <div class="row">
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img-box">
                                ...
                                <div class="project-one__content">
                                    <!-- <p class="project-one__sub-title">Express Electrical</p> -->
                                    <h3 class="project-one__title"><a href="#">Electrical EPC Project</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img-box">
                                ...
                                <div class="project-one__content">
                                    ...
                                    <h3 class="project-one__title"><a href="#">MEP (mechanical, electrical and plumbing)</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img-box">
                                ...
                                <div class="project-one__content">
                                    ...
                                    <h3 class="project-one__title"><a href="#">Data Centers</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img-box">
                                ...
                                <div class="project-one__content">
                                    ...
                                    <h3 class="project-one__title"><a href="#">Solar </a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img-box">
                                ...
                                <div class="project-one__content">
                                    ...
                                    <h3 class="project-one__title"><a href="#">LT Panles</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!--Project One Single End-->
                    <!--Project One Single Start-->
                    <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="1100ms">
                        <div class="project-one__single">
                            <div class="project-one__img-box">
                                <div class="project-one__img">
                                ...
                                <div class="project-one__content">
                                    ...
                                    <h3 class="project-one__title"><a href="#"> Solution Based  R & D Products</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
